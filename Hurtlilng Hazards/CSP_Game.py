...
score_guy.speed(0)
score_guy.goto(200, 300) # Position for score
...
def update_player_pos(x_change):
    ...
    # Set heading (for a better visual effect when moving)
    if x_change < 0:
        player.setheading(90) # Tilt left slightly
    elif x_change > 0:
        player.setheading(90) # Tilt right slightly
    else:
        player.setheading(90)
